...
public class simpleExecutor implements Executor {
    ...
    public int update(Configuration configuration, MappedStatement mappedStatement, Object... params) throws Exception {
        ...
        // 设置参数
        DefaultPreparedStatementHandler defaultPreparedStatementHandler = new DefaultPreparedStatementHandler();
        PreparedStatement preparedStatement = defaultPreparedStatementHandler.doHandler(configuration, mappedStatement, boundSql, params);
